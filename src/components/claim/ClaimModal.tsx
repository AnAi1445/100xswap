        ...
        <ContentWrapper gap="lg">
          ...
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              As a member of the 1000xgems community you may claim UNI to be used for voting and governance. <br /> <br />
              <ExternalLink href="#">Read more about 100xgems</ExternalLink>
            </TYPE.subHeader>
            <ButtonPrimary
